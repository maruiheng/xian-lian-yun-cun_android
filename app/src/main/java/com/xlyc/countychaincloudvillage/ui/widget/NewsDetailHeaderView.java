...
import com.xlyc.countychaincloudvillage.relation.ShowPicRelation;
...
public class NewsDetailHeaderView extends FrameLayout {
    ...
    public void setDetail(NewsDetail detail, LoadWebListener listener) {
        ...
        if (detail.media_user == null) {
            ...
            mTvTime.setText(com.xlyc.countychaincloudvillage.utils.DateUtils.getShortTime(detail.publish_time * 1000L));
        }
